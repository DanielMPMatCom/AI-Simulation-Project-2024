...
class ChiefElectricCompanyAgent(Person):
    ...
    def get_cost_to_meet_demand_from_thermoelectric_to_block(  # TODO : OPTIMIZE THE FUNCTION
        ...
        for tid, cid, cost in self.beliefs[
            "distance_template"
        ].value:  # TODO : MAKE DISTANCE MATRIX
            if tid == thermoelectric_id and circuit_id == cid:
                distance_cost = cost
                break
        ...
        return cost + block.demand_per_hour[hour]
